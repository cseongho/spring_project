                  ...
                  <div class="tab-content">
                    <div role="tabpanel" class="tab-pane fade in active" id="buyTicket">
                    	<div class="row">
                        	...
                        	<form action="siteUpdateAction?linkNo=<c:out value="${param.linkNo}"/>&catNo=<c:out value="${param.catNo}"/>" method="post">
						   	<table>
						   	<c:forEach var="site" items="${site_list}">
								<h1>링크 수정</h1><br/>
					        	<tr>
					        		<td>링크 요약 </td>
					        		<td><input type="text" name="title" value="${site.title}"></td>
					        	</tr>
					        	<tr>
					        		<td>URL </td>
					        		<td><input type="text" name="link" value="${site.link}"></td>
					        	</tr>
					        	<tr>
					        		<td>링크 메모 </td>
					        		<td><textarea rows="5" cols="40" name="content">${site.content}</textarea></td>
					        	</tr>
					        	</c:forEach>
							</table>
