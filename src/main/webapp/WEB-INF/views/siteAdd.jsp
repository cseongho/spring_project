						...
						<div class="navigation">
							<ul>
								...
								<c:forEach var="cat" items="${cat_list}">
									...
									<a href="categoryDelekdteAction?no=${cat.no}" onclick="return confirm('삭제하시겠습니까?');"><span class="glyphicon glyphicon-remove"></span></a>
									</li>
								</c:forEach>
							</ul>
							<ul>
                    ...
                    <div role="tabpanel" class="tab-pane fade in active" id="buyTicket">
                    	<div class="row">
		                    ...
		                    <div role="tabpanel" class="tab-pane fade in active" id="buyTicket">
		                    	<div class="row">
                        			<br/><br/><br/>
                        				<form action="siteAddAction?no=<c:out value="${param.no}"/>" method="post">
									   		<table>
									   		<h1>링크 추가</h1><br/>
											<tr>
												<td>링크 요약 </td>
											...
											<tr>
												<td>URL </td>
												<td><input type="text" name="link" autofocus="autofocus" required="required"/></td>
											</tr>
											<tr>
												<td>링크 메모 </td>
												<td><textarea rows="5" cols="40" name="content" autofocus="autofocus" required="required"></textarea></td>
											</tr>
											<tr>
